...
# __str__: Devolverá una cadena de la siguiente forma: “Me llamo nombre, tengo x patas y sueno así: sonido”. Habrá que sustituir lo que está 
# en azul por el nombre y el número de patas del animal. En el caso de sonido hay que llamar a la función habla.
